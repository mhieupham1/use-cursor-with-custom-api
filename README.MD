...
![Ảnh chụp màn hình cửa sổ Settings với tab Models được chọn](images/step3_models_tab.png)
...
![Ảnh chụp mục OpenAI API Key đã nhập Key và bật Override Base URL](images/step4_api_config.png)
...
![Ảnh chụp hành động nhập tên model và nhấn nút thêm](images/step5_add_custom_model.png)
